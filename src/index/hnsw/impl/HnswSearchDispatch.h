...
template <class Evaluation = faiss::cppcontrib::knowhere::FullDistanceEvaluation>
...
search_hnsw_query(const faiss::cppcontrib::knowhere::HNSW& graph, faiss::DistanceComputer& distance,
    ...
    auto run = [&](auto& visitor, const auto& selector) {
        ...
        faiss::cppcontrib::knowhere::v2_hnsw_searcher<faiss::DistanceComputer, Visitor,
                                                      faiss::cppcontrib::knowhere::Bitset, Selector, Evaluation>
