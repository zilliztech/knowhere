...
KNOWHERE_DEFINE_PROMETHEUS_HISTOGRAM_FAMILY(graph_search_candidate_limit, "graph search candidate limit")
KNOWHERE_DEFINE_PROMETHEUS_HISTOGRAM(graph_search_candidate_limit, PROMETHEUS_LABEL_CARDINAL)
