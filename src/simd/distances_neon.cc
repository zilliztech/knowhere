...
fp16_vec_L2sqr_neon(const knowhere::fp16* x, const knowhere::fp16* y, size_t d) {
    ...
    while (d >= 16) {
        ...
        res.val[1] = vaddq_f32(vmulq_f32(a.val[1], a.val[1]), res.val[1]);
        res.val[2] = vaddq_f32(vmulq_f32(a.val[2], a.val[2]), res.val[2]);
        res.val[3] = vaddq_f32(vmulq_f32(a.val[3], a.val[3]), res.val[3]);
        d -= 16;
        x += 16;
        y += 16;
    }
    ...
    if (d >= 8) {
        ...
        a.val[1] = vsubq_f32(a.val[1], b.val[1]);
        res.val[0] = vaddq_f32(vmulq_f32(a.val[0], a.val[0]), res.val[0]);
        res.val[2] = vaddq_f32(vmulq_f32(a.val[1], a.val[1]), res.val[2]);
        d -= 8;
        x += 8;
        y += 8;
    }
    ...
    if (d >= 0) {
        ...
        res.val[0] = vaddq_f32(vmulq_f32(diff, diff), res.val[0]);
    }
    return vaddvq_f32(res.val[0]);
}
