...
class KnowhereConfig {
 public:
     ...
     * 128) should not exceed this value. You can type `sudo sysctl -a | grep fs.aio-max-nr` on your terminal to see
    ...
    static void
    SetFetchObjectThreadPoolSize(size_t num_threads);
    static size_t
    GetFetchObjectThreadPoolSize();
