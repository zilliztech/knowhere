...
constexpr const char* MH_LSH_SEARCH_WITH_JACCARD = "search_with_jaccard";
// minhash lsh index params
constexpr const char* MH_LSH_ALIGNED_BLOCK_SIZE = "aligned_block_size";
constexpr const char* MH_LSH_BAND = "band";
constexpr const char* MH_LSH_SHARED_BLOOM_FILTER = "shared_bloom_filter";
constexpr const char* MH_LSH_BLOOM_FALSE_POSITIVE_RPOB = "bloom_false_positive_prob";
constexpr const char* MH_LSH_HASH_CODE_IN_MEM = "hash_code_in_mem";
constexpr const char* MH_LSH_REFINE_K = "refine_k";
constexpr const char* MH_LSH_BATCH_SEARCH = "batch_search";
}  // namespace indexparam
