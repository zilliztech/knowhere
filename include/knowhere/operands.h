...
//
enum class DataFormatEnum { fp32, fp16, bf16, int8, bin1, sparse_fp32 };
...
template <>
struct DataType2EnumHelper<knowhere::sparse_fp32> {
    static constexpr DataFormatEnum value = DataFormatEnum::sparse_fp32;
};
