...
#define KNOWHERE_SIMPLE_REGISTER_ALL_GLOBAL(name, index_node, features, ...)                                                       \
    ...
    KNOWHERE_SIMPLE_REGISTER_GLOBAL(name, index_node, sparse_fp32, (features | knowhere::feature::SPARSE_FLOAT32), ##__VA_ARGS__);
...
#define KNOWHERE_SIMPLE_REGISTER_SPARSE_FLOAT_GLOBAL(name, index_node, features, ...)                              \
    KNOWHERE_SIMPLE_REGISTER_GLOBAL(name, index_node, sparse_fp32, (features | knowhere::feature::SPARSE_FLOAT32), \
                                    ##__VA_ARGS__);
