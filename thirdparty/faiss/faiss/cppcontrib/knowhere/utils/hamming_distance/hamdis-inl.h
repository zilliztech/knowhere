...
#include <faiss/cppcontrib/knowhere/utils/hamming_distance/common.h>

#ifdef __aarch64__
// ARM compilers may produce inoptimal code for Hamming distance somewhy.
#include <faiss/cppcontrib/knowhere/utils/hamming_distance/neon-inl.h>
#elif __AVX2__
// better versions for GenHammingComputer
#include <faiss/cppcontrib/knowhere/utils/hamming_distance/avx2-inl.h>
#else
#include <faiss/cppcontrib/knowhere/utils/hamming_distance/generic-inl.h>
#endif
