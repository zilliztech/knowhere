...
#include <faiss/cppcontrib/knowhere/utils/structure-inl.h>
...
#define binary_knn_mc_Substructure(ncodes)                           \
    case ncodes:                                                     \
        binary_knn_mc<faiss::cppcontrib::knowhere::StructureComputer##ncodes<false>>(      \
...
#undef binary_knn_mc_Substructure
                default:
                    binary_knn_mc<faiss::cppcontrib::knowhere::StructureComputerDefault<false>>(
                            ncodes, a, b, na, nb, k, distances, labels, sel);
                    break;
            }
            break;
...
#define binary_knn_mc_Superstructure(ncodes)                         \
    case ncodes:                                                     \
        binary_knn_mc<faiss::cppcontrib::knowhere::StructureComputer##ncodes<true>>(       \
                ncodes, a, b, na, nb, k, distances, labels, sel); \
        break;
...
#undef binary_knn_mc_Superstructure
                default:
                    binary_knn_mc<faiss::cppcontrib::knowhere::StructureComputerDefault<true>>(
                            ncodes, a, b, na, nb, k, distances, labels, sel);
                    break;
            }
            break;
...
#define binary_knn_hc_jaccard(ncodes)                     \
    case ncodes:                                          \
        binary_knn_hc<C, faiss::cppcontrib::knowhere::JaccardComputer##ncodes>( \
...
#undef binary_knn_hc_jaccard
                    default:
                        binary_knn_hc<C, faiss::cppcontrib::knowhere::JaccardComputerDefault>(
                                ncodes, ha, a, b, nb, sel);
                        break;
                }
            }
...
#define binary_knn_hc_hamming(ncodes)                     \
    case ncodes:                                          \
        binary_knn_hc<C, faiss::cppcontrib::knowhere::HammingComputer##ncodes>( \
                ncodes, ha, a, b, nb, sel);            \
        break;
...
#undef binary_knn_hc_hamming
                    default:
                        binary_knn_hc<C, faiss::cppcontrib::knowhere::HammingComputerDefault>(
                                ncodes, ha, a, b, nb, sel);
                        break;
                }
            }
...
#define binary_range_search_jaccard(ncodes)                        \
    case ncodes:                                                   \
        binary_range_search<C, T, faiss::cppcontrib::knowhere::JaccardComputer##ncodes>( \
...
#undef binary_range_search_jaccard
                    default:
                        binary_range_search<
                                C,
                                T,
                                faiss::cppcontrib::knowhere::JaccardComputerDefault>(
                                a, b, na, nb, radius, code_size, res, sel);
                        break;
                }
            }
...
#define binary_range_search_hamming(ncodes)                        \
    case ncodes:                                                   \
        binary_range_search<C, T, faiss::cppcontrib::knowhere::HammingComputer##ncodes>( \
                a, b, na, nb, radius, code_size, res, sel);     \
        break;
...
#undef binary_range_search_hamming
                    default:
                        binary_range_search<
                                C,
                                T,
                                faiss::cppcontrib::knowhere::HammingComputerDefault>(
                                a, b, na, nb, radius, code_size, res, sel);
                        break;
                }
            }
...
#define all_jaccard_distances_jaccard(ncodes)                        \
    case ncodes:                                                     \
        all_jaccard_distances_template<faiss::cppcontrib::knowhere::JaccardComputer##ncodes>( \
...
#undef all_jaccard_distances_jaccard
        default:
            all_jaccard_distances_template<faiss::cppcontrib::knowhere::JaccardComputerDefault>(
                    x, y, d, nx, ny, output, sel);
            break;
    }
}
...
#define all_hamming_distances_hamming(ncodes)                        \
    case ncodes:                                                     \
        all_hamming_distances_template<faiss::cppcontrib::knowhere::HammingComputer##ncodes>( \
                x, y, d, nx, ny, output, sel);                   \
        break;
...
#undef all_hamming_distances_hamming
        default:
            all_hamming_distances_template<faiss::cppcontrib::knowhere::HammingComputerDefault>(
                    x, y, d, nx, ny, output, sel);
            break;
    }
}
