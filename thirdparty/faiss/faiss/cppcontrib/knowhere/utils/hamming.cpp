...
void hammings(
    ...
    switch (ncodes) {
        case 8:
            faiss::cppcontrib::knowhere::hammings<64>(C64(a), C64(b), na, nb, dis);
            return;
        case 16:
            faiss::cppcontrib::knowhere::hammings<128>(C64(a), C64(b), na, nb, dis);
            return;
        case 32:
            faiss::cppcontrib::knowhere::hammings<256>(C64(a), C64(b), na, nb, dis);
            return;
        case 64:
            faiss::cppcontrib::knowhere::hammings<512>(C64(a), C64(b), na, nb, dis);
            return;
        default:
            faiss::cppcontrib::knowhere::hammings(C64(a), C64(b), na, nb, ncodes * 8, dis);
            return;
    }
}
...
void hamming_count_thres(
    ...
    switch (ncodes) {
        case 8:
            faiss::cppcontrib::knowhere::hamming_count_thres<64>(
                    C64(bs1), C64(bs2), n1, n2, ht, nptr);
            return;
        case 16:
            faiss::cppcontrib::knowhere::hamming_count_thres<128>(
                    C64(bs1), C64(bs2), n1, n2, ht, nptr);
            return;
        case 32:
            faiss::cppcontrib::knowhere::hamming_count_thres<256>(
                    C64(bs1), C64(bs2), n1, n2, ht, nptr);
            return;
        case 64:
            faiss::cppcontrib::knowhere::hamming_count_thres<512>(
                    C64(bs1), C64(bs2), n1, n2, ht, nptr);
            return;
        default:
...
void crosshamming_count_thres(
    ...
    switch (ncodes) {
        case 8:
            faiss::cppcontrib::knowhere::crosshamming_count_thres<64>(C64(dbs), n, ht, nptr);
            return;
        case 16:
            faiss::cppcontrib::knowhere::crosshamming_count_thres<128>(C64(dbs), n, ht, nptr);
            return;
        case 32:
            faiss::cppcontrib::knowhere::crosshamming_count_thres<256>(C64(dbs), n, ht, nptr);
            return;
        case 64:
            faiss::cppcontrib::knowhere::crosshamming_count_thres<512>(C64(dbs), n, ht, nptr);
            return;
        default:
            FAISS_THROW_FMT("not implemented for %zu bits", ncodes);
    }
...
size_t match_hamming_thres(
    ...
    switch (ncodes) {
        case 8:
            return faiss::cppcontrib::knowhere::match_hamming_thres<64>(
                    C64(bs1), C64(bs2), n1, n2, ht, idx, dis);
        case 16:
            return faiss::cppcontrib::knowhere::match_hamming_thres<128>(
                    C64(bs1), C64(bs2), n1, n2, ht, idx, dis);
        case 32:
            return faiss::cppcontrib::knowhere::match_hamming_thres<256>(
                    C64(bs1), C64(bs2), n1, n2, ht, idx, dis);
        case 64:
            return faiss::cppcontrib::knowhere::match_hamming_thres<512>(
                    C64(bs1), C64(bs2), n1, n2, ht, idx, dis);
        default:
            FAISS_THROW_FMT("not implemented for %zu bits", ncodes);
            return 0;
