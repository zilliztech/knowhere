...
void ProductQuantizer::compute_code(const float* x, uint8_t* code) const {
    switch (nbits) {
        case 8:
            faiss::cppcontrib::knowhere::compute_code<PQEncoder8>(*this, x, code);
            break;

        case 16:
            faiss::cppcontrib::knowhere::compute_code<PQEncoder16>(*this, x, code);
            break;

        default:
            faiss::cppcontrib::knowhere::compute_code<PQEncoderGeneric>(*this, x, code);
            break;
    }
}
...
void ProductQuantizer::decode(const uint8_t* code, float* x) const {
    switch (nbits) {
        case 8:
            faiss::cppcontrib::knowhere::decode<PQDecoder8>(*this, code, x);
            break;

        case 16:
            faiss::cppcontrib::knowhere::decode<PQDecoder16>(*this, code, x);
            break;

        default:
            faiss::cppcontrib::knowhere::decode<PQDecoderGeneric>(*this, code, x);
            break;
    }
}
