...
if(__X86_64)
  ...
  target_compile_options(sparse_simd_avx512 PRIVATE -mavx512f -mavx512dq -mavx512bw)
  ...
  target_include_directories(sparse_seek_avx512 PRIVATE ${Boost_INCLUDE_DIRS})
