...
#                    thirdparty/faiss/faiss/impl/*amx.cpp)
...
if(__X86_64)
  ...
  add_library(utils_amx OBJECT ${UTILS_AMX_SRC})
  ...
  add_library(
    ...
    $<TARGET_OBJECTS:utils_avx512> $<TARGET_OBJECTS:utils_avx512icx> $<TARGET_OBJECTS:utils_amx>)
