...
TEST_CASE("Test bf16 patch", "[bf16 patch]") {
    ...
    REQUIRE(faiss::enable_ref_patch_fp32_bf16 == false);
    REQUIRE(faiss::enable_avx_patch_fp32_bf16 == false);
    REQUIRE(faiss::enable_avx512_patch_fp32_bf16 == false);
    ...
    REQUIRE(faiss::enable_ref_patch_fp32_bf16 == true);
    REQUIRE(faiss::enable_avx_patch_fp32_bf16 == true);
    REQUIRE(faiss::enable_avx512_patch_fp32_bf16 == true);
